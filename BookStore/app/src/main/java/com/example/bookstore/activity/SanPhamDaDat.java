...
import com.example.bookstore.adapter.SanPhamDaDatAdapter;
import com.example.bookstore.model.Sanphamdadat;
...
public class SanPhamDaDat extends AppCompatActivity {
    ...
    private TextView txthangdatrong;
    ...
    private void GetDataDaDat() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Server.Duongdansanphamdadat, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                CheckConnection.ShowToast_short(getApplicationContext(),"Chua load du lieu");
            }
        });
